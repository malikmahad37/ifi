    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <motion.div className="space-y-4" variants={{ hidden: { y: 20, opacity: 0 }, visible: { y: 0, opacity: 1 } }}>
            <div className="space-y-2">
              ...
              <h3 className="text-[9px] font-black tracking-[0.3em] uppercase text-theme-base/80 [.light-theme_&]:text-theme-base/90">
                Ittefaq Fasteners Industries
              </h3>
            </div>
            <p className="text-theme-base/40 [.light-theme_&]:text-theme-base/70 text-[11px] leading-relaxed max-w-xs">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-theme-base/60 [.light-theme_&]:text-theme-base/80 text-[10px] font-bold leading-relaxed">{contact.address}</p>
                </div>
              </li>
              <li className="flex items-center gap-3 text-theme-base/60 [.light-theme_&]:text-theme-base/80 text-[10px] font-bold tracking-widest">
        ...
        <div className="border-t border-theme-base/5 pt-6 text-center md:text-left">
          <p className="text-theme-base/30 [.light-theme_&]:text-theme-base/50 text-[8px] uppercase font-black tracking-[0.4em]">
